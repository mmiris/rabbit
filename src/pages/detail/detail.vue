...
const changeHandler: UniHelper.SwiperOnChange = (e) => {
  imgIdx.value = e.detail.current
}
...
<template>
  ...
  <scroll-view scroll-y class="viewport" v-else>
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper circular @change="changeHandler">
          <swiper-item v-for="goods in detail?.mainPictures" :key="goods">
            <image mode="aspectFill" :src="goods" @tap="tapHandler(goods)" />
          </swiper-item>
        </swiper>
        <view class="indicator">
          <text class="current">{{ imgIdx + 1 }}</text>
      ...
      <view class="action">
        ...
        <view class="item arrow" @tap="popupHandler('service')">
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item" v-for="item in detail?.details.properties" :key="item.name">
